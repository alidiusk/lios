...
gdt_null: ; mandatory null descriptor
    dd 0x0 ; 'dd' means define double word (4-byte)
    dd 0x0
...
gdt_code: ; the code segment descriptor
    ...
    db 0x0 ; Base (bites 16-23)
    db 10011010b ; 1st flags, type flags
    db 11001111b ; 2nd flags, limit (bits 16-19)
    db 0x0 ; Base (bits 24-31)

gdt_data: ; the data segment descriptor
    ; Same as code descriptor except for the type flags:
...
; put a label here so that we can calculate the size of the of the GDT for the
; GDT descriptor later
gdt_end:
