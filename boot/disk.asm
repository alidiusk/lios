...
disk_load:
    pusha
    ; we need all registers to read from disk so overwrite input parameters
    ; from dx; save to stack for later use
    push dx
    ...
    mov ch, 0x00 ; ch <- cylinder (0x0 .. 0x3FF, upper two bytes in 'cl')
    ...
    pop dx
    cmp al, dh ; bios also sets 'al' to number of sectors read. compare it
    jne sectors_error
    popa
    ret
